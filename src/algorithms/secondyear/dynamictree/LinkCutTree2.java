...
public class LinkCutTree2 {
    ...
    private void link(int a, int b) {
        Node ab = new Node(a, b, 0);
        Node ba = new Node(b, a, 0);
    ...
    private void solve() throws IOException {
        ...
        for (int i = 0; i < m; i++) {
            ...
            switch (query) {
                ...
                case "size":
                    a = in.nextInt() - 1;
                    System.out.println(getSize(Nodes[a]));
                    break;
            }
        }
    }
